// generated by gitops_sync.task.ts !! do not edit directly or risk lost data
					...
					},
					{
						...
						declarations: [
							...
							},
							{
								...
								source_line: 159,
								type_signature:
									'(syntax_styler: SyntaxStyler, tag_name: string, lang: string): void',
								return_type: 'void',
								parameters: [
									{
										name: 'syntax_styler',
					...
					},
					{
						...
						declarations: [
							...
							},
							{
								...
								source_line: 103,
								type_signature:
									'(repo: LocalRepo, log?: Logger | undefined): Promise<ChangesetInfo[]>',
						...
						declarations: [
							{
								...
								source_line: 11,
								type_signature:
									'{ readonly PROD: "prod"; readonly PEER: "peer"; readonly DEV: "dev"; }',
							},
							{
								name: 'DependencyType',
								kind: 'type',
							...
							},
							{
								...
								members: [
									...
									},
									{
										...
										type_signature:
											'(): { production_cycles: string[][]; dev_cycles: string[][]; }',
										...
										throws: [
											{
												type: 'if',
												description:
													'production/peer cycles detected (cannot be resolved by exclusion)',
											},
										],
									},
									{
					...
					},
					{
						...
						declarations: [
							...
							},
							{
								...
								source_line: 10,
								type_signature:
									'(gitops_config: GitopsConfig, repos_dir: string): ResolvedGitopsConfig',
